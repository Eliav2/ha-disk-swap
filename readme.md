...
> One exception: the Disk Swap add-on itself isn't restored into the clone (by design) — reinstall it from the add-on store afterwards if you want it on the cloned machine.
